...
export const metadata = {
  title: "Toronto HVAC SEO & 3-Pack Case Study | Metro Valley",
  description:
    "See how Metro Valley Digital propelled a local HVAC contractor from page 4 to #1 on Google Maps 3-Pack, driving 340% inbound inquiries and $480K in revenue.",
  alternates: {
    canonical: "https://metrovalleydigital.com/portfolio-single",
  },
  openGraph: {
    title: "Toronto HVAC SEO & 3-Pack Case Study | Metro Valley",
    description:
      "See how Metro Valley Digital propelled a local HVAC contractor from page 4 to #1 on Google Maps 3-Pack, driving 340% inbound inquiries and $480K in revenue.",
    url: "https://metrovalleydigital.com/portfolio-single",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Toronto HVAC Local SEO Case Study",
      },
    ],
  },
  twitter: {
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: "Toronto HVAC Case Study", url: "/portfolio-single" },
        ]}
      />
      <Breadcrumbs
            ...
            <div className="col-lg-8 col-12">
              <div className="p-single-main">
                ...
                <div className="p-single-content mt-4">
                  ...
                  <h2 style={{ fontSize: "28px", fontWeight: "800", color: "#0f172a" }}>Scaling Google Maps 3-Pack Dominance Across the Greater Toronto Area</h2>
                  ...
                  <h3 style={{ fontSize: "22px", fontWeight: "700", color: "#0f172a", marginTop: "24px" }}>The Results & Commercial Impact</h3>
                  <p style={{ color: "#475569", fontSize: "16px", lineHeight: "1.7" }}>
              ...
              <div className="portfolio-sidebar">
                ...
                <div className="p-sidebar-widget" style={{ background: "#f8fafc", padding: "24px", borderRadius: "12px", border: "1px solid #e2e8f0" }}>
                  <div className="project-info">
                    <h3 className="p-widget-title" style={{ fontWeight: "700", borderBottom: "2px solid #28b463", paddingBottom: "8px", marginBottom: "16px" }}>Project Scope</h3>
                ...
                <div className="p-sidebar-widget mt-4" style={{ background: "linear-gradient(135deg, #28b463 0%, #16a34a 100%)", padding: "24px", borderRadius: "12px", color: "#ffffff" }}>
                  <h3 style={{ color: "#ffffff", fontWeight: "700", marginBottom: "12px" }}>Want Similar Results?</h3>
